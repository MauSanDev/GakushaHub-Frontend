...
const SummaryModal = ({
    ...
    return ReactDOM.createPortal(
        <div className="fixed inset-0 bg-black bg-opacity-80 flex items-center justify-center z-50 transition-opacity duration-300 opacity-100">
            <div className="bg-gray-900 p-6 rounded-lg shadow-lg text-white w-11/12 md:w-1/2 lg:w-1/3 transition-transform duration-300 transform scale-100">
                ...
                <div className="flex justify-center gap-4">
                    ...
                    <button
                        onClick={onRetryAll}
                        className="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 rounded-full flex items-center gap-2"
                    >
                        <FaRedo />
                        Retry All
                    </button>
                    <button
                        ...
                        className="bg-red-500 hover:bg-red-600 text-white font-bold py-2 px-4 rounded-full flex items-center gap-2"
                    >
                        <FaTimes />
                        Close
                    </button>
