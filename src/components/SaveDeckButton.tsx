...
const SaveDeckButton: React.FC<SaveDeckButtonProps> = ({ kanjiIds, wordIds, grammarIds, readingIds, onSaveStatusChange, deckName, lessonName, courseId, courseName , saveStatus}) => {
